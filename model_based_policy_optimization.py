# model-based policy optimization, MBPO, 基于模型的策略优化
...
class MBPO:
    def __init__(self, env, agent, fake_env, env_pool, model_pool,
        ...
        self.rollout_length = rollout_length    # 使用环境模型进行推演的长度
        self.rollout_batch_size = rollout_batch_size
        self.real_ratio = real_ratio
        self.num_episode = num_episode

    # 从真实动作序列中随机采样1条数据, 并通过环境模型进行rollout_length步推演
    ...
    # 从真实环境和环境模型交互的数据中采样数据进行agent的学习
